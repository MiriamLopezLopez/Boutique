...
public class EmpleadoController {
	...
	@GetMapping(value = "/empleado/gestionempleado")
	...
	@PostMapping(value = "/empleado/agregar")
	...
	@GetMapping(value = "/empleado/actualizarempleado/{id}")
	...
	@GetMapping(value = "/empleado/eliminarempleado/{id}")
